...
public class Eliminar extends javax.swing.JFrame 
{
    ...
    String consulta = "DELETE CLIENTES WHERE COD LIKE '"+cod+"'";
    ...
    public void Eliminar()
    {
        try
        {
           ...
           JOptionPane.showMessageDialog(null, "Se ha eliminado los datos del \n cliente satisfactoriamente");
           bot.abrirAdministrar();
           this.setVisible(false);
           rs.close();
           cn.close();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTfecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 410, 140, 30));
        ...
        getContentPane().add(jTcod, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 250, 140, 30));
        ...
        getContentPane().add(jTnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 330, 140, 30));

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/bot_Eliminar.png"))); // NOI18N
        ...
        Wallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/baseEliminar.png"))); // NOI18N
