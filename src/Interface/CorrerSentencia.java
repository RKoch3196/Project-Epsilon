...
public class CorrerSentencia extends javax.swing.JFrame {
    ...
    public CorrerSentencia() {
        initComponents();
        this.setLocationRelativeTo(null);
    }

    public void correrConsulta()
    {
        try
        {
           cn = Logica.Enlace(cn);
           rs=Logica.EnlEst(rs,(cconsulta.getText()).toUpperCase()); 
           
           System.out.println((cconsulta.getText()).toUpperCase());
        }
        catch (Exception e)
        {
            JOptionPane.showMessageDialog(null, "Error al al correr la sentencia \n "+e);
        }
    }
    ...
    private void initComponents() {
        ...
        cconsulta = new javax.swing.JTextPane();
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 340, 550, 110));

        cconsulta.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jScrollPane1.setViewportView(cconsulta);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 240, 550, 90));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CorrerSentencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CorrerSentencia().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextPane cconsulta;
